...
Esta classe implementa um conjunto ordenado (elementos únicos em ordem) que suporta inserção, remoção e pesquisa em O(log n) tempo médio.
...
### Implementação de um Leaderboard (Ranking)
